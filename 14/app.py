...
def login():
    ...
    if request.method == 'POST' and 'email' in request.form and 'password' in request.form:
        ...
        if user:
            ...
            message = 'Logged in successfully!'  # Assign a value to message
...
def register():
    ...
    if request.method == 'POST':
        ...
        if account:
            ...
            cursor.execute('INSERT INTO user (name, email, password, role, country) VALUES (%s, %s, %s, %s, %s)',
...
def index():
    ...
    return render_template('Category.html', new_goods=new_goods, sale_goods=sale_goods, hot_goods=hot_goods)
